...
var _TableComponent = require('./TableComponent.jsx');

var _TableComponent2 = _interopRequireDefault(_TableComponent);

var _ItemModal = require('./ItemModal.jsx');

var _ItemModal2 = _interopRequireDefault(_ItemModal);

var _SummaryComponent = require('./SummaryComponent.jsx');
...
var BagItems = function (_React$Component) {
    _inherits(BagItems, _React$Component);

    function BagItems() {
        _classCallCheck(this, BagItems);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(BagItems).call(this));
        ...
        _this.calculation = _this.calculation.bind(_this);
        _this.sizeChange = _this.sizeChange.bind(_this);
        return _this;
    }

    _createClass(BagItems, [{
        ...
        value: function componentDidMount() {
            ...
            _jquery2.default.ajax({
                ...
                result.productsInCart.forEach(function (item) {
                    item.total_price = item.p_price;
                });
                _this2.setState({
                    cartItems: result.productsInCart
                });
                _this2.calculation(_this2.state.cartItems);
            }).fail(function (error) {
        ...
        key: 'quantityChange',
        value: function quantityChange(p_id, number, price) {
            if (number >= 0) {
        ...
        key: 'sizeChange',
        value: function sizeChange(p_id, size) {
            if (!!size) {
                var newItems = this.state.cartItems;
                newItems.map(function (item) {
                    if (item.p_id === p_id) {
        ...
        key: 'removeItem',
        value: function removeItem(p_id) {
            var newItems = this.state.cartItems;
            var index = 0;
        ...
        key: 'calculation',
        value: function calculation(newItems) {
            var subtotal = 0;
            var total = 0;
        ...
        key: 'editItem',
        value: function editItem(p_id) {
            var _this3 = this;

            if (!!p_id) {
                this.state.cartItems.forEach(function (item) {
                    if (item.p_id === p_id) {
                        _react2.default.render(_react2.default.createElement(_ItemModal2.default, { item: item, visible: true, qtyChange: _this3.quantityChange, sizeChange: _this3.sizeChange }), document.getElementById("modal"));
                    }
                });
            }
        }
        ...
        value: function render() {
            if (this.state.cartItems.length !== 0) {
                return _react2.default.createElement(
                    'section',
                    null,
                    _react2.default.createElement(_TableComponent2.default, {
                        cartItems: this.state.cartItems,
                        quantityChange: this.quantityChange,
                        removeItem: this.removeItem,
                        editItem: this.editItem }),
                    _react2.default.createElement(_SummaryComponent2.default, { subtotal: this.state.subtotal, total: this.state.total })
                );
            } else {
                return _react2.default.createElement(
                    'section',
...
},{"./ItemModal.jsx":159,"./SummaryComponent.jsx":160,"./TableComponent.jsx":161,"jquery":1,"react":157}],159:[function(require,module,exports){
'use strict';
...
var ItemModal = function (_React$Component) {
    _inherits(ItemModal, _React$Component);

    function ItemModal(props) {
        _classCallCheck(this, ItemModal);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ItemModal).call(this, props));
        ...
        _this.quantityChange = _this.quantityChange.bind(_this);
        _this.sizeChange = _this.sizeChange.bind(_this);
        _this.returnModal = _this.returnModal.bind(_this);
        return _this;
    }
    ...
    _createClass(ItemModal, [{
        ...
        value: function closeModal() {
            _react2.default.unmountComponentAtNode(document.getElementById('modal'));
        }
    }, {
        key: 'getSizes',
        value: function getSizes(sizelist) {
            var _this2 = this;

            var sizes = [];
            sizelist.forEach(function (size) {
                if (_this2.props.item.p_selected_size.code == size.code) {
                    sizes.push(_react2.default.createElement(
                        'option',
                        { value: size.code, selected: true },
                        size.code.toUpperCase()
                    ));
                } else {
                    sizes.push(_react2.default.createElement(
                        'option',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'button',
                                { type: 'button', onClick: this.closeModal, className: 'close', 'data-dismiss': 'modal', 'aria-hidden': 'true' },
                                'X '
                            )
                        ),
                        _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            ...
                                            _react2.default.createElement(
                                                'span',
                                                { className: 'currency center' },
                                                this.props.item.c_currency
                                            ),
                                            _react2.default.createElement(
                                                'span',
                                                { className: 'item-price' },
                                                this.props.item.p_price
                                            )
                                        ),
                                        _react2.default.createElement(
                                            'div',
                                            ...
                                            _react2.default.createElement(
                                                'span',
                                                { className: 'toupper center modal-size' },
                                                'Size'
                                            ),
                                            _react2.default.createElement(
                                                'select',
                                                { className: 'form-control modal-size-select', 'data-id': this.props.item.p_id, onChange: this.sizeChange },
                                                this.getSizes(this.props.item.p_available_options.sizes)
                                            ),
                                            _react2.default.createElement(
                                                'span',
                                                { className: 'toupper center modal-qty' },
                                                'qty'
                                            ),
                                            _react2.default.createElement('input', { type: 'number', className: 'center form-control modal-qty-value', value: this.props.item.p_quantity, 'data-id': this.props.item.p_id, 'data-price': this.props.item.p_price, onChange: this.quantityChange })
                                        )
                                    ),
                                    _react2.default.createElement(
                                        'button',
                                        { type: 'button', className: 'btn btn-primary save-items toupper', onClick: this.closeModal },
                                        'edit'
                                    ),
                                    _react2.default.createElement(
                                        'button',
                                        { type: 'button', className: 'btn btn-link see-detail', onClick: this.closeModal },
                                        'See product details'
                                    )
                                ),
                                _react2.default.createElement(
                                    'div',
                                    { className: 'col-md-6' },
                                    _react2.default.createElement('img', { className: 'item-image', src: './assets/T' + this.props.item.p_id + '.jpg', alt: '' + this.props.item.p_name })
                                )
                            )
                        )
                    )
...
var SummaryComponent = function (_React$Component) {
    ...
    function SummaryComponent() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(SummaryComponent).apply(this, arguments));
    }
    ...
    _createClass(SummaryComponent, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "aside",
                    { className: "support col-md-4 hidden-xs" },
                    _react2.default.createElement(
                        "h4",
                        null,
                ...
                _react2.default.createElement(
                    "section",
                    { className: "paysection col-sm-8 col-xs-12" },
                    _react2.default.createElement(
                        "section",
                        { className: "promocode row" },
                        _react2.default.createElement(
                            "div",
                            { className: "col-md-8" },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement("input", { className: "form-control", type: "number" })
                        ),
                        _react2.default.createElement(
                            "div",
                            { className: "col-md-2 col-xs-6" },
                            _react2.default.createElement("input", { className: "btn btn-default toupper", type: "button", value: "Apply" })
                        )
                    ),
                    _react2.default.createElement(
                        "section",
                        { className: "priceSection row" },
                        _react2.default.createElement(
                            "div",
                            { className: "price" },
                            _react2.default.createElement(
                                "span",
                                { className: "cost-component toupper" },
                                "subtotal"
                            ),
                            _react2.default.createElement(
                                "span",
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "span",
                                { className: "cost-component-total toupper" },
                                "estimated total"
                            ),
                            _react2.default.createElement(
                                "span",
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "div",
                            { className: "col-xs-offset-3 col-md-offset-6 col-sm-3" },
                            _react2.default.createElement(
                                "button",
                                { className: "btn btn-link toupper" },
                                "Continue Shopping"
                            )
                        ),
                        _react2.default.createElement(
                            "div",
                            { className: "col-xs-offset-2 col-xs-8 col-md-offset-0 col-sm-3" },
                            _react2.default.createElement(
                                "button",
                                { className: "btn btn-primary toupper", style: { width: '100%' } },
                                "Checkout"
                            )
                        )
                    ),
                    _react2.default.createElement(
                        "section",
                        { className: "col-md-offset-4 right" },
                        _react2.default.createElement("img", { src: "./assets/lock.jpg", alt: "", style: { display: 'inline-block' } }),
                        _react2.default.createElement(
                            "span",
                            { className: "secure" },
...
var TableComponent = function (_React$Component) {
    ...
    function TableComponent(props) {
        ...
        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TableComponent).call(this, props));
    ...
    _createClass(TableComponent, [{
        ...
        key: "withDiscount",
        value: function withDiscount(item) {
            return _react2.default.createElement(
                "span",
                null,
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "del",
                        { className: "discount" },
                        item.p_originalprice % 1 !== 0 ? item.p_originalprice : item.p_originalprice + ".00"
                    )
                ),
                _react2.default.createElement(
                    "span",
        ...
        key: "noDiscount",
        value: function noDiscount(item) {
            return _react2.default.createElement(
                "span",
                { className: "item-price" },
                _react2.default.createElement(
        ...
        key: "createDetailRow",
        value: function createDetailRow(item) {
            return _react2.default.createElement(
                "tr",
                { className: "tablerow" },
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement("img", { src: "./assets/T" + item.p_id + ".jpg", alt: "" + item.p_name })
                        ),
                        _react2.default.createElement(
                            "div",
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement("input", { className: "center form-control smlqty", type: "number", onChange: this.handleOnChange, "data-price": item.p_price, "data-id": item.p_id, value: item.p_quantity })
                            ),
                            _react2.default.createElement(
                                "div",
                                { className: "visible-xs" },
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "actions hidden-xs" },
                                _react2.default.createElement(
                                    "a",
                                    { href: "javascript: void(0);", "data-id": item.p_id, onClick: this.editItem, className: "toupper action-button" },
                                    "edit"
                                ),
                                _react2.default.createElement("div", { className: "divider" }),
                                _react2.default.createElement(
                                    "a",
                                    { href: "javascript: void(0);", "data-id": item.p_id, onClick: this.handleRemove, className: "toupper action-button remove-btn" },
                                    "x remove"
                                ),
                                _react2.default.createElement("div", { className: "divider" }),
                                _react2.default.createElement(
                                    "a",
                                    { href: "javascript: void(0);", className: "toupper action-button remove-btn" },
                                    "save for later"
                                )
                            )
                        ),
                        _react2.default.createElement(
                            "div",
                            { className: "small-actions visible-xs col-xs-12 container" },
                            _react2.default.createElement(
                                "a",
                                { href: "javascript: void(0);", "data-id": item.p_id, onClick: this.editItem, className: "toupper action-button" },
                                "edit"
                ...
                _react2.default.createElement(
                    "td",
                    { className: "col-sm-1 hidden-xs center toupper" },
                    item.p_selected_size.code
                ),
                _react2.default.createElement(
                    "td",
                    { className: "col-sm-1 hidden-xs center" },
                    _react2.default.createElement("input", { className: "center form-control", type: "number", onChange: this.handleOnChange, "data-price": item.p_price, "data-id": item.p_id, value: item.p_quantity })
                ),
                _react2.default.createElement(
                    "td",
                    { className: "col-sm-1 hidden-xs right" },
                    item.p_price === item.p_originalprice ? this.noDiscount(item) : this.withDiscount(item)
                )
            );
        }
        ...
        value: function render() {
            ...
            this.props.cartItems.forEach(function (item) {
                rows.push(_this2.createDetailRow(item));
            });
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                "div",
                                { className: "visible-xs item-head col-xs-8" },
                                "YOUR SHOPPING BAG"
                            ),
                            _react2.default.createElement(
                                "div",
                                { className: "visible-xs item-head col-xs-4" },
                        ...
                        _react2.default.createElement(
                            "th",
                            { className: "col-sm-9 hidden-xs" },
                            this.props.cartItems.length,
                            " Items"
                        ),
                        _react2.default.createElement(
                            "th",
                            { className: "col-sm-1 center hidden-xs" },
                            "Size"
                        ),
                        _react2.default.createElement(
                            "th",
                        ...
                        _react2.default.createElement(
                            "th",
                            { className: "col-sm-1 right hidden-xs" },
                            "Price"
                        )
                    )
                ),
...
TableComponent.propTypes = {
    cartItems: _react2.default.PropTypes.array.isRequired
};
...
var _shoppingBag = require('./shoppingBag.jsx');

var _shoppingBag2 = _interopRequireDefault(_shoppingBag);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_react2.default.render(_react2.default.createElement(_shoppingBag2.default, null), document.getElementById("mainApp"));

},{"./shoppingBag.jsx":163,"react":157}],163:[function(require,module,exports){
'use strict';
...
var _BagItems = require('./BagItems.jsx');

var _BagItems2 = _interopRequireDefault(_BagItems);
...
var ShoppingBag = function (_React$Component) {
    ...
    function ShoppingBag() {
        ...
        return _possibleConstructorReturn(this, Object.getPrototypeOf(ShoppingBag).apply(this, arguments));
    }
    ...
    _createClass(ShoppingBag, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_BagItems2.default, null)
            );
        }
    }]);
...
},{"./BagItems.jsx":158,"react":157}]},{},[162]);
